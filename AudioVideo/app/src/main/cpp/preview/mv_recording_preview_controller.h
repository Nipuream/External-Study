...
#include "../video_encode/video_encoder_adapter.h"
#include "../video_encode/hw_encoder/hw_encoder_adapter.h"
#include "../video_encode/soft_encoder/soft_encoder_adapter.h"
